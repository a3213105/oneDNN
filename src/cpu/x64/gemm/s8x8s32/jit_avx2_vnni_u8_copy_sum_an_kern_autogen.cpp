...
#define ARG_BIAS (72 + stacksize + rsp)
    ...
    inLocalLabel();
    {
        ...
        uni_vmovq(xmm4, qword[A1 - 0x70]);
        add(A1, LDA);
        uni_vmovq(xmm6, qword[A1 - 0x70]);
        punpcklbw(xmm4, xmm6);
        ...
        jle(labels[2], T_NEAR);
        movdqu(xmm0, xword[A1 - 0x80]);
        uni_vmovq(xmm1, qword[A1 - 0x70]);
        add(A1, LDA);
        movdqu(xmm2, xword[A1 - 0x80]);
        uni_vmovq(xmm3, qword[A1 - 0x70]);
        add(A1, LDA);
        movdqa(xmm4, xmm0);
        punpcklbw(xmm0, xmm2);
        punpckhbw(xmm4, xmm2);
